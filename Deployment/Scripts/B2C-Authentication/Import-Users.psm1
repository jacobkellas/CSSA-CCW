...
function Import-Users {
    ...
    foreach ($user in $usersFromJson.users) {
      ...
      $user | Add-Member -NotePropertyName password -NotePropertyValue (New-RandomPassword -length 14) # generate a random password
    ...
    return $usersFromJson.users | Select-Object email, password, gameMaster # The display name is not needed anywhere later so we filter it out
  }
  ...
  Export-ModuleMember Import-Users
  Export-ModuleMember Add-Users
