...
{
    public class RequestPermitApplicationToMailingAddressMapper : IMapper<PermitApplicationRequestModel, MailingAddress?>
    {
        public MailingAddress? Map(PermitApplicationRequestModel source)
        {
