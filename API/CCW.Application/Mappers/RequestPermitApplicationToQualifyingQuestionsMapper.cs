...
public class RequestPermitApplicationToQualifyingQuestionsMapper : IMapper<PermitApplicationRequestModel, QualifyingQuestions>
{
    public QualifyingQuestions Map(PermitApplicationRequestModel source)
    {
