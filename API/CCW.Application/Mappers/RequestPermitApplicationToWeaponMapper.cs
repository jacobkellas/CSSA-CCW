...
{
    public class RequestPermitApplicationToWeaponMapper : IMapper<PermitApplicationRequestModel, Weapon[]>
    {
        public Weapon[] Map(PermitApplicationRequestModel source)
        {
