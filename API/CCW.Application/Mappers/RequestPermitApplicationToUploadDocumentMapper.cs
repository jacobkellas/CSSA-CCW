...
public class RequestPermitApplicationToUploadDocumentMapper : IMapper<PermitApplicationRequestModel, UploadedDocument[]>
{
    public UploadedDocument[] Map(PermitApplicationRequestModel source)
    {
