...
public interface ICosmosDbService
{
    ...
    Task<PermitApplication?> GetLastApplicationAsync(string userId, string userEmailOrOrderId, bool isOrderId, bool isComplete, CancellationToken cancellationToken);
