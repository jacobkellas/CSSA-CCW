...
public interface ICosmosDbService
{
    ...
    Task<PermitApplication?> GetLastApplicationAsync(string userId, string orderId, bool isComplete, CancellationToken cancellationToken);
    ...
    Task<PermitApplication?> GetUserApplicationAsync(string orderId, CancellationToken cancellationToken);
